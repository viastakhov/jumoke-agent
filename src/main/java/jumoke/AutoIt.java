...
public class AutoIt implements IAutoIt {
	...
	public AutoIt(boolean highlightMode, int highlightDelay) throws IOException {
		...
		String libPath = null;
		if (Platform.isWindows()) {libPath = Platform.is64Bit() ? "/libs/autoitx/AutoItX3_x64.dll" : "/library/autoitx/AutoItX3.dll";};
	...
	public void highlightControl(String szTitle, String szText, String szControl, byte flashStyle) {
		if (this.highlightMode) {
			...
			//Jumoke.log.info("<< highlightControl (" + szTitle_ + ", " + szText_ + ", " + szControl_ + ")");
		}
	}
	...
	@Override
	public void AU3_ControlTreeView(WString szTitle, WString szText,
			WString szControl, WString szCommand, WString szExtra1,
			WString szExtra2, CharBuffer szResult, int nBufSize) {
